...
function intersectPlane(
  ...
  _u_ci.subVectors(b, a);
  _v_ci.subVectors(a, p);
  const dot1 = n.dot(_u_ci);
  const dot2 = n.dot(_v_ci);
  _u_ci.multiplyScalar(-dot2/dot1);
  target.addVectors(a, _u_ci);
